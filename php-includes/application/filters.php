<div id="ventu-filters">
    ...
    <div id="ventu-filter-content">
        ...
        <div id="ventu-filter-search-area" class="ventu-filter-section">
            ...
            <div class="ventu-filter-label-container">
                <div class="ventu-filter-passive-text">
                    Niet actief
                </div>
            </div>
        ...
        <!-- tools -->
        <div id="ventu-filter-tools" class="ventu-filter-section">
            <div class="ventu-filter-tools-button ventu-filter-tools-button--save">
                <div class="ventu-filter-tools-button-label">
