...
App.prototype.initDomElements = function() {
    this.domElements.last =  null;
    this.domElements.container = $('.ventu-stack-container');
    this.domElements.favoritesCounter = $('.ventu-favorites-counter');
    this.domElements.counter = $('.ventu-counter span');
    this.domElements.suggest = $('.ventu-suggest');
    this.domElements.loveButton = $('.ventu-love-button');
    this.domElements.hateButton = $('.ventu-hate-button');
};
