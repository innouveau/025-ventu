...
Card.prototype._create = function () {
    ...
    card = $('<div class="ventu-card">' +
        ...
        '<div class="ventu-card-text">' +
            '<h4>' + content.text.sub + '</h4><h3>' + content.text.head + '</h3>' +
    ...
    this.buttons.love = $('<div class="ventu-card-button"><div class="ventu-card-button-icon ventu-icon-love"><div class="ventu-ripple"></div></div><span class="Interessant">interessant</span></div>');
    this.buttons.hate = $('<div class="ventu-card-button"><div class="ventu-card-button-icon ventu-icon-hate"><div class="ventu-ripple"></div></div><span class="NietInteressant">niet interessant</span></div>');
